    ...
    <div class="row mt-4">
      ...
      <div class="col-xl-8 col-lg-5 col-md-4 col-12 mt-2">
        <div class="single-product">
          <div class="product-content">
            <h4 style="font-weight: 500;">Isi Keranjang</h4>
            <div class="table-responsive">
              ...
              <div class="justify-content-end mt-2" style="float: left;">
                <button type="submit" rel="tooltip" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit mr-1 ml-auto"></i>Perbarui Keranjang</button>
              </div>
              <div class="justify-content-end mt-2 ml-2" style="float: left;">
                <a href="<?= base_url('belanja/clear') ?>" rel="tooltip" class="btn btn-outline-success btn-sm"><i class="fa fa-refresh mr-1 ml-auto"></i>Hapus Keranjang</a>
              </div>
      ...
      <div class="col-xl-4 col-lg-6 col-md-4 col-12 mt-2">
        <div class="single-product">
          ...
          <div class="product-content">
            <h4 style="font-weight: 500;">Total Keranjang</h4>
            <div class="row">
              <div class="col-sm-7">
                Sub total
              </div>
          ...
          <div class="justify-content-end mt-4" style="float: right;">
            <a href="<?= base_url('website/checkout') ?>" rel="tooltip" class="btn btn-warning ">Pesan Sekarang<i class="fa fa-chevron-right ml-1 "></i></a>
          </div>
        </div>
      </div>
      <?php echo form_close(); ?>
