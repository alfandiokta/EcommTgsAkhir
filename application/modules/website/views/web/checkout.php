      ...
      <div class="col-xl-8 col-lg-5 col-md-4 col-12 mt-2">
        <div class="single-product">
          <div class="product-content">
            <h4 style="font-weight: 500;">Detail Pemesan</h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="email" placeholder="name@contoh.com" class="form-control form-control-alternative" name="email" value="<?= $user['email']; ?>"/>
                    <?= form_error('email', ' <small class="text-danger">', '</small>'); ?>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="nomor telepon" class="form-control form-control-alternative" name="telp" />
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md">
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="Alamat" class="form-control form-control-alternative" name="alamat" />
                  </div>
                </div>

              </div>
              <button type="submit" rel="tooltip" class="btn btn-warning"><i class="fa fa-shopping-bag mr-1 ml-auto"></i>Pesan Sekarang</button>
            </form>
          </div>
        </div>
      </div>
